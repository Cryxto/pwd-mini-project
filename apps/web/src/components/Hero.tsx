...
function Hero() {
  return (
    ...
    <section
      id="hero"
      className="w-full h-[93vh] relative self-center shadow-lg drop-shadow-2xl bg-black"
    >
      <div style={{position: 'relative', minHeight: '100%', minWidth: '100vw'}}>
        <Image
          className="top-0 left-0 w-full h-[93vh] object-cover  shadow-2xl relative"
      ...
      <div className="bg-black/80 absolute top-0 left-0 w-full h-[93vh] " />
